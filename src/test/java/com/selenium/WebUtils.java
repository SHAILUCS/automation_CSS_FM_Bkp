...
class WebUtils {
	...
	/**
	 * When the WebElement Object is located, use this method to get the underlying By Object.
	 * 
	...
	public WebElement findElement(By byObj) {
		return findElement(byObj, "", false);
	}
	...
	public WebElement findElement(Object parentElem, By childByObj) {
		return findElement(parentElem, childByObj,"", false);
	}
	 ...
	 */
	public WebElement findElement(Object parentElem, By childByObj, String desc, boolean trueForSnapshot) {
	 ...
	 *             If no matching elements are found
	 */
	public WebElement findElement(By byObj, boolean trueForWholePageSnapshot) {
		return findElement(byObj, "", trueForWholePageSnapshot);
	}
	...
	public WebElement findElement(By byObj, String desc) {
		return findElement(byObj, desc, true);
	}
	 ...
	 *             If no matching elements are found
	 */
	public WebElement findElement(By byObj, String desc, boolean trueForSnapshot) {
		WebElement temp = null;
		boolean reportFlag = false;
		StackTraceElement[] ste =Thread.currentThread().getStackTrace();
		String methodName=ste[1].getMethodName();
