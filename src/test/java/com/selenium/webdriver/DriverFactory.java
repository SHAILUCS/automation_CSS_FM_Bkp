...
public class DriverFactory {
	...
	public static void startChromeDriverService(HashMap<TestNGKeys, String> testDataMap) {
		DriverType driverType = determineEffectiveDriverType(testDataMap.get(TestNGKeys.browser));
		if(driverType.equals(DriverType.CHROME) || driverType.equals(DriverType.CHROME_HEADLESS)) {
			try {
