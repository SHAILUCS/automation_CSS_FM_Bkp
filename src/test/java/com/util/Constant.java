...
public class Constant {
	 ...
	 */
	private static final String browserBinaryFolderName = "DriverBinaries";
	private static final String bit = "64bit";
	public static final String geckoDriverFileName_Win = "geckodriver.exe";
	public static final String geckoDriverFileName_Linux = "geckodriver";
	...
	private static final String resDataFolderName = "Resources";
	...
	private static String environmentInfoSheet = "ADMIN-DEV";
	...
	public static String snapshotsMovieTemplateFilePath() {
		String path = root + "/" + resDataFolderName + "/" + snapshotsMovieTemplateName;
		return path;
	}

	public static String getReportRedesignTemplateFilePath() {
		String path = root + "/" + resDataFolderName + "/" + reportRedesignTemplateName;
		return path;
	}

	public static String getHistoryReportRedesignTemplateFilePath() {
		String path = root + "/" + resDataFolderName + "/" + historyReportRedesignTemplateName;
		return path;
	}
	...
	public static String getTestDataFolderPath() {
		String path = root + "/" + resDataFolderName;
		return path;
	}

	public static String getTestDataFilePath() {
		String path = root + "/" + resDataFolderName + "/" + testDataFileName;
		return path;
	}
	...
	public static String getResultextenthtmlfilePath() {
		String path = root + "/" + reportFolderName + "/" + resultExtentHTMLFileName;
		return path;
	}

	public static String getResultHtmlFilePath() {
		String path = root + "/" + reportFolderName + "/" + reportRedesignTemplateName;
		return path;
	}

	public static String getResultFolderPath() {
		String val = root + "/" + reportFolderName;
	...
	public static String getFirefoxDriverLocation() {
		...
		String val = "";
		if (platform.toLowerCase().contains("lin") || platform.toLowerCase().contains("ubu")) {
			val = root + "/" + browserBinaryFolderName + "/selenium_standalone_binaries/linux/marionette/" + bit + "/"
					+ geckoDriverFileName_Linux;
		} else if (platform.toLowerCase().contains("win")) {
			val = root + "/" + browserBinaryFolderName + "/selenium_standalone_binaries/windows/marionette/" + bit + "/"
					+ geckoDriverFileName_Win;
		}
		System.out.println("DRIVER BINARY: " + val);
		return val;
	}
	...
	public static String getChromeDriverLocation() {
		...
		String val = "";
		if (platform.toLowerCase().contains("lin") || platform.toLowerCase().contains("ubu")) {
			val = root + "/" + browserBinaryFolderName + "/selenium_standalone_binaries/linux/googlechrome/" + bit + "/"
					+ chromeDriverFileName_Linux;
		} else if (platform.toLowerCase().contains("win")) {
			val = root + "/" + browserBinaryFolderName + "/selenium_standalone_binaries/windows/googlechrome/" + bit
	...
	public static String getIEDriverLocation() {
		String val = root + "/" + browserBinaryFolderName + "/selenium_standalone_binaries/windows/internetexplorer/"
				+ bit + "/" + ieDriverFileName;
		return val;
	}

	public static String getEdgeDriverLocation() {
		String val = root + "/" + browserBinaryFolderName + "/selenium_standalone_binaries/windows/edge/" + bit + "/"
				+ edgeDriverFileName;
		return val;
	}
